 ...
 * ${TAGS}
 */
public class RecommendHotPathAdapter extends BaseQuickAdapter<HomeBean.DataBean.RouteBean,BaseViewHolder>{

    private  Context context;

    public RecommendHotPathAdapter(int layoutResId, @Nullable List<HomeBean.DataBean.RouteBean>  data, Context context) {
        super(R.layout.recommend_hot_path_item, data);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, HomeBean.DataBean.RouteBean item) {
        Glide.with(context).load(item.getImg()).into((ImageView) helper.getView(R.id.img_recommend_hot_path));
    }
